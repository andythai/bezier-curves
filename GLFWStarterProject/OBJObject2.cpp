...
#include "OBJObject2.h"
#include "../Window.h"

OBJObject2::OBJObject2()
{}

OBJObject2::OBJObject2(const char* filepath)
{
	parse(filepath);
	initialize();
}

OBJObject2::OBJObject2(bool cube) {
	vertices = {
		// "Front" vertices
...
void OBJObject2::parse(const char* filepath)
{
...
void OBJObject2::draw(GLuint shaderProgram)
{
...
void OBJObject2::origin_preserve_z()
{
	glm::mat4 matrix =
	{ 1, 0, 0, 0,
		0, 1, 0, 0,
...
void OBJObject2::reset()
{
	this->toWorld = glm::mat4(1.0f);
}

void OBJObject2::scale(float mult)
{
...
void OBJObject2::orbit(float deg)
{
...
void OBJObject2::rotate(float angle, glm::vec3 axis)
{
	this->toWorld = glm::rotate(glm::mat4(1.0f), angle / 180.0f * glm::pi<float>(), axis) * this->toWorld;
}

void OBJObject2::setAmbient(float r, float g, float b)
{
	object_color = { r, g, b };
}

void OBJObject2::setDiffuse(float r, float g, float b)
{
	diffuse = { r, g, b };
}

void OBJObject2::setSpecular(float r, float g, float b)
{
	specular = { r, g, b };
}

void OBJObject2::setShininess(int number)
{
	if (number > 128) {
		shininess = 128;
	}
